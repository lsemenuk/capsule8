...
func (NetworkAddressFamily) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_f2f81e3f7e35c6d0, []int{0}
}
...
func (*IPv4AddressAndPort) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_f2f81e3f7e35c6d0, []int{1}
}
func (m *IPv4AddressAndPort) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_IPv4AddressAndPort.Unmarshal(m, b)
}
func (m *IPv4AddressAndPort) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_IPv4AddressAndPort.Marshal(b, m, deterministic)
}
func (dst *IPv4AddressAndPort) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IPv4AddressAndPort.Merge(dst, src)
}
func (m *IPv4AddressAndPort) XXX_Size() int {
	return xxx_messageInfo_IPv4AddressAndPort.Size(m)
}
func (m *IPv4AddressAndPort) XXX_DiscardUnknown() {
	xxx_messageInfo_IPv4AddressAndPort.DiscardUnknown(m)
}

var xxx_messageInfo_IPv4AddressAndPort proto.InternalMessageInfo
...
func (*IPv6Address) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_f2f81e3f7e35c6d0, []int{2}
}
...
func (dst *IPv6Address) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IPv6Address.Merge(dst, src)
}
...
func (*IPv6AddressAndPort) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_f2f81e3f7e35c6d0, []int{3}
}
func (m *IPv6AddressAndPort) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_IPv6AddressAndPort.Unmarshal(m, b)
}
func (m *IPv6AddressAndPort) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_IPv6AddressAndPort.Marshal(b, m, deterministic)
}
func (dst *IPv6AddressAndPort) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IPv6AddressAndPort.Merge(dst, src)
}
func (m *IPv6AddressAndPort) XXX_Size() int {
	return xxx_messageInfo_IPv6AddressAndPort.Size(m)
}
func (m *IPv6AddressAndPort) XXX_DiscardUnknown() {
	xxx_messageInfo_IPv6AddressAndPort.DiscardUnknown(m)
}

var xxx_messageInfo_IPv6AddressAndPort proto.InternalMessageInfo
...
func (*NetworkAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_f2f81e3f7e35c6d0, []int{4}
}
...
func (*Credentials) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_f2f81e3f7e35c6d0, []int{5}
}
...
func init() { proto.RegisterFile("capsule8/api/v0/types.proto", fileDescriptor_types_f2f81e3f7e35c6d0) }

var fileDescriptor_types_f2f81e3f7e35c6d0 = []byte{
